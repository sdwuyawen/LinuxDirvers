 ...
 * =====================================================================================
 *
 *       Filename:  kernel_rw.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  04/11/2015 09:35:21 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
int ker_rw_ioctl (struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
{
...
static int ker_rw_init(void)
{
	...
	class_device_create(class, NULL, MKDEV(major, 0), NULL, "ker_rw"); /*  */
...
static void ker_rw_exit(void)
{
	...
	class_destroy(class);
	unregister_chrdev(MKDEV(major, 0), "ker_rw");
}
