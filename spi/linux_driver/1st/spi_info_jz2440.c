...
static struct spi_board_info spi_info_jz2440[] = {
	{
    	 ...
    	 .mode    = SPI_MODE_0,
    	 .chip_select   = S3C2410_GPF1, /* oled_cs, 它的含义由spi_master确定 */
    	 .platform_data = S3C2410_GPG4, /* oled_dc, 它在spi_driver里使用 */    	 
	 },
	 {
    	 ...
    	 .bus_num = 1,     /* jz2440里OLED接在SPI CONTROLLER 1 */
    	 .mode    = SPI_MODE_0,
    	 .chip_select   = S3C2410_GPG2, /* flash_cs, 它的含义由spi_master确定 */
	 }
}
